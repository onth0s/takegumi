export default function Center() {
  return (
    <div className="flex flex-col items-center gap-4 w-full max-w-md">
      {/* Drop zone */}
      <div className="group flex flex-col items-center justify-center gap-2 w-full h-64 border border-dashed border-border-default rounded-xl bg-surface cursor-pointer transition-colors duration-200 hover:border-accent/50 hover:bg-accent/5 px-6 text-center">
